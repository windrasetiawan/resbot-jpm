...
async function jpm(sock, sender, message, key, msg) {
    ...
    if (!text) return sock.sendMessage(sender, { text: "⚠️ Masukkan pesan! Contoh: .jpm {Halo|Hai} kawan." });
    ...
    await sock.sendMessage(sender, { text: `🚀 Memulai JPM Manual ke ${targets.length} grup...` });
