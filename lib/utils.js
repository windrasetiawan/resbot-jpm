...
// Import daftar nomor owner dari config
...
// --- FUNGSI IS OWNER (Penambahan Baru) ---
function isOwner(sender) {
    if (!sender) return false;
    // Hapus karakter non-digit (@s.whatsapp.net dll)
    const num = sender.replace(/\D/g, ""); 
    // Cek apakah ada di list numberAllowed
...
// PENTING: Export isOwner ditambahkan di sini
export {
  readWhitelist,
